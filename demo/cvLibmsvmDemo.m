% How to Use: 
%  libsvm-2.85 (BSD licence) for windows is ready for you. Move them 
%  into your current directory (not cvprtoolbox directory, but your 
%  working directory) or modify path in this file.
%  You may download LIBSVM from the web and compile and replace them. 
Xp = [
...
% main
cvLibmsvmTrain(Xp, Cp);
Ct = cvLibmsvmPredict(Xt);
